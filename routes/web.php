...
Route::prefix('admin')->middleware(['auth'])->group(function () 
{
        ...
        ->name('admin.reports.activeCustomersByPublishDate');
            Route::get('/reports/active-customers-by-publish-date/export', [ReportController::class, 'exportActiveCustomersByPublishDate'])
        ->name('admin.reports.activeCustomersByPublishDate.export');
